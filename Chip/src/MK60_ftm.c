...
//                                     );
    FTM_QDCTRL_REG(FTMN[ftmn]) &= ~FTM_QDCTRL_QUADMODE_MASK; //选定编码模式为A相与B相编码模式
    FTM_CNTIN_REG(FTMN[ftmn])   = 0;
    FTM_MOD_REG(FTMN[ftmn])     = 10000;//FTM_MOD_MOD_MASK;
    //FTM_SC_REG(FTMN[ftmn]) |= FTM_SC_CLKS(3);  //选择外部时钟
    FTM_QDCTRL_REG(FTMN[ftmn]) |=   (0
