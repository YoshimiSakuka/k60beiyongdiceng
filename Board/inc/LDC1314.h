...
extern int SpeedWant;
extern int Speed_Kp; 
extern int Speed_Ki; 
extern int Speed_Kd; 

extern void LDC1314_Init(void);
extern void LDC1314_CH_Read(uint16 *LDCstr);
extern void LDC1314_Run(void);
extern int Speed_Control(int Speed_Test);
